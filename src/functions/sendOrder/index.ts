    ...
    const params: SendEmailCommandInput = {
        ...
        Message: {
            ...
            Body: {
                Text: {
                    Charset: 'UTF-8',
                    Data: `Your warranty has been expired against order number ${id}. You ordered ${companyName} ${carName}\n`
                        + `Click the link to renew order ${process.env.baseUrl}/renew?id=${orderRenewalId}`
                }
            }
        }
    }
...
const sendSMS = async ({
    ...
    const params: PublishCommandInput = {
        ...
        Message: `Your warranty has been expired against order number ${id}. You ordered ${companyName} ${carName}\n`
            + `Click the link to renew order ${process.env.baseUrl}/renew?id=${orderRenewalId}`
    }
